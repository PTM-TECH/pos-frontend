...
export default function BillingPage() {
  ...
  const amount = selectedPlan?.price ?? sub?.plan_price ?? 0;
  ...
  async function handleSubmitPayment(e: React.FormEvent) {
    ...
    try {
      await submitPayment({
        ...
        amount,
        plan_id: selectedPlanId ?? sub.plan_id,
      });
      toast.success(
        ...
        {loading ? (
          ...
          <>
            ...
            <div>
              ...
              {selectedPlan && selectedPlan.id !== sub?.plan_id && (
                <p className="text-xs text-emerald-600 mt-1.5">
                  Switching from {sub?.plan} to {selectedPlan.name} on payment
                  confirmation
                </p>
              )}
            </div>
            ...
            <div className="bg-white rounded-xl border border-gray-200 p-6 space-y-5">
              <div className="bg-emerald-50 border border-emerald-200 rounded-xl p-4 space-y-3">
                ...
                <ol className="text-sm text-gray-700 space-y-1.5 list-decimal list-inside">
                  ...
                  <li>
                    Select <strong>Lipa na M-Pesa → Pochi La Biashara</strong>
                  </li>
                  <li>
                    Enter Number: <strong>0795310021</strong>
                  </li>
                  <li>
                    Enter amount:{" "}
              ...
              <div className="flex items-start gap-2 text-xs text-gray-500 bg-gray-50 rounded-lg p-3">
                ...
                <span>
                  Your subscription stays inactive until we verify your
                  payment, usually within 30 minutes during business hours.
                  You&apos;ll regain access automatically once approved.
                </span>
              </div>
            </div>
          </>
