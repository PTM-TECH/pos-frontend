      ...
      <div className="w-full max-w-sm">
        ...
        {sent ? (
          <div className="text-center space-y-4">
            ...
            <Link
              href="/login"
              className="inline-flex items-center gap-1.5 cursor-pointer text-sm font-medium text-emerald-600 hover:text-emerald-700"
            >
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <Link
              href="/login"
              className="flex items-center justify-center cursor-pointer gap-1.5 text-sm font-medium text-gray-500 hover:text-gray-700 pt-1"
            >
              <ArrowLeft className="w-4 h-4" />
              Back to sign in
            </Link>
