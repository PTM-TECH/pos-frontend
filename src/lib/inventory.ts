...
export interface InventoryValue {
  ...
  inventory_value_revenue: number;
}

export async function getInventoryValue(storeId?: number, categoryId?: number) {
  const response = await api.get<ApiResponse<InventoryValue>>(
