...
export default function PurchaseDetailModal({
  ...
  const [returningItem, setReturningItem] = useState<PurchaseItem | null>(null);
        ...
        <div className="p-6 space-y-4">
          <div className="grid grid-cols-2 gap-3 text-sm">
            ...
            <div>
              ...
              <span
                className={`inline-block text-[10px] font-medium px-1.5 py-0.5 rounded border ${getStatusColor(purchase.status)}`}
              >
