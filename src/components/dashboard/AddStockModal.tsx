    ...
    <Modal title={`Add Stock: ${product.name}`} onClose={onClose}>
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div className="grid grid-cols-2 gap-3">
          ...
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-1.5">
              Cost Price (Buy) <span className="text-red-500">*</span>
            </label>
            <input
              type="number"
              required
        ...
        <button
          type="submit"
          disabled={loading}
          className="w-full cursor-pointer bg-emerald-600 text-white py-2.5 rounded-lg text-sm font-medium hover:bg-emerald-700 transition-colors disabled:opacity-60"
        >
