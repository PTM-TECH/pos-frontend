          ...
          return (
            ...
            >
              ...
              <div className="flex items-center justify-between mt-auto pt-2">
                ...
                <span
                  className={`text-[10px] font-medium px-1.5 py-0.5 rounded border ${getStatusColor(product.status)}`}
                >
              ...
              <button
                ...
                disabled={outOfStock}
                className="mt-3 w-full cursor-pointer bg-emerald-600 text-white py-2 rounded-lg text-xs font-medium
